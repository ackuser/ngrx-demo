(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-crud-crud-module~app-crud2-crud2-module"],{
...
/***/ "./src/app/in-memory-api/employee-in-memory-data.ts":
/*!**********************************************************!*\
  !*** ./src/app/in-memory-api/employee-in-memory-data.ts ***!
  \**********************************************************/
/*! exports provided: EmployeeInMemoryData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeInMemoryData", function() { return EmployeeInMemoryData; });
var EmployeeInMemoryData = /** @class */ (function () {
    function EmployeeInMemoryData() {
    }
    EmployeeInMemoryData.prototype.createDb = function () {
        var employees = [
            {
                'id': 1,
                'name': 'James Smith',
...
/***/ "./src/app/in-memory-api/employee.service.ts":
/*!***************************************************!*\
  !*** ./src/app/in-memory-api/employee.service.ts ***!
  \***************************************************/
...
/* harmony import */ var _app_in_memory_api_in_memory_api_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/in-memory-api/in-memory-api.module */ "./src/app/in-memory-api/in-memory-api.module.ts");
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.createEmployee = function (employee) {
        return this.http.post(this.apiEmployeeURL, employee, { headers: this.headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            return response;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleAndThrowRemoteError.bind(this)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
            console.log('Clean up your resource here ');
    ...
    EmployeeService.prototype.updateEmployee = function (employee) {
        var url = this.apiEmployeeURL + "/" + employee.id;
        return this.http.put(url, employee, { headers: this.headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleAndThrowRemoteError.bind(this)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
            console.log('Clean up your resource here ');
        }));
    };
    EmployeeService.prototype.removeEmployee = function (id) {
        var url = this.apiEmployeeURL + "/" + id;
        return this.http.delete(url, { headers: this.headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleAndThrowRemoteError.bind(this)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
            console.log('Clean up your resource here ');
        }));
    };
    EmployeeService.prototype.handleAndThrowRemoteError = function (error) {
    ...
    EmployeeService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: _app_in_memory_api_in_memory_api_module__WEBPACK_IMPORTED_MODULE_2__["InMemoryApiModule"]
        }),
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
/***/ "./src/app/in-memory-api/in-memory-api.module.ts":
/*!*******************************************************!*\
  !*** ./src/app/in-memory-api/in-memory-api.module.ts ***!
  \*******************************************************/
/*! exports provided: InMemoryApiModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InMemoryApiModule", function() { return InMemoryApiModule; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _app_in_memory_api_employee_in_memory_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @app/in-memory-api/employee-in-memory-data */ "./src/app/in-memory-api/employee-in-memory-data.ts");
...
var InMemoryApiModule = /** @class */ (function () {
    function InMemoryApiModule() {
    }
    InMemoryApiModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                ...
                angular_in_memory_web_api__WEBPACK_IMPORTED_MODULE_4__["HttpClientInMemoryWebApiModule"].forRoot(_app_in_memory_api_employee_in_memory_data__WEBPACK_IMPORTED_MODULE_3__["EmployeeInMemoryData"], { delay: 500 }),
            ]
        })
    ], InMemoryApiModule);
    return InMemoryApiModule;
}());
...
//# sourceMappingURL=default~app-crud-crud-module~app-crud2-crud2-module.js.map